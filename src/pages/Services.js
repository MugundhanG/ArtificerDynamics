...
function ServiceSection({ service, index }) {
  ...
  return (
    <section id={service.id} className={`py-20 lg:py-28 ${isEven ? 'bg-white' : 'bg-gray-50'}`}>
  ...
  return (
    <>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <span className="text-accent font-semibold text-sm uppercase tracking-widest">Our Expertise</span>
            <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-white mt-3 mb-6">
              Engineering Services
            </h1>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Comprehensive engineering solutions spanning the full product lifecycle — from concept to validated, production-ready designs.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <CTASection
        ...
        description="Every project is unique. Tell us about your challenge, and we'll craft a tailored approach that delivers results."
